...
function FlowRate({setShowFlowRate, wallet, loanAdress, defaultFlowRate, actualFlowRate, setSnackBar, setActualFlowRate}: FlowRateProps){
    ...
    const lendAction = async (e: React.MouseEvent<HTMLButtonElement>) => {
        try{
            ...
            const tx = await employerFlow(type, wallet, loanAdress, flowRate);
